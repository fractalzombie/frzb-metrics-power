...
use FRZB\Component\MetricsPower\OptionResolver\Resolver\SentryOptionResolver;
...
test('It can capture exception when not set for retry', function (): void {
    ...
    $sentryOptionsResolver = new SentryOptionResolver($sentryHub);
...
test('It has correct type', function (): void {
    expect(SentryOptionResolver::getType())->toBe(SentryOptions::class);
});
